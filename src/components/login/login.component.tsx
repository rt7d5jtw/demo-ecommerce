...
export const Login = () => {
  ...
  return (
    <div className='login'>
    <div className='login-picture' style={{backgroundImage:`url('https://i.imgur.com/0c2Zp0s.jpg')`}}>
    </div>
    <div className='login-wrapper'>
      ...
      <label>Email</label>
        ...
        <Link to='/register'><p className='register-link'>Dont have an account yet? Click here to register</p></Link>
      </form>
    </div>
    </div>
  );
