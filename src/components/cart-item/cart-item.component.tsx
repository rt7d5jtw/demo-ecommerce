  ...
  return (
    <div className='cart-item'>
      <div className='cart__right-div'>
        <div className='cart-image' style={{backgroundImage: `url(${cartItem.image})`}}>
        </div>
      </div>
      ...
      <button className='remove-btn' title="Removes the product from cart" onClick={() => removeHandler()}>X</button>
    </div>
  );
}
